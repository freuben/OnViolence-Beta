OnViolenceScore {var s, basicPath, <>score, globalMIDI, globalTimes, start, end, bufferTimes, selectPitch, buffType, algoTimes, <>stepPedal, <>chooseSamples, <>countPedalOn,<>countPedalOff,<>tempo=176, <>partials, <percglobalTimesGlob,<>midiout, partialTrig=0, document, bufferArr;
